     ...
     <div class="container mt-5">
         <div class="container text-center">
             <div class="row row-cols-5">
               ...
               <a href="announcement.php" class="col btn btn-dark m-2 py-4">
               <i class="fa fa-bullhorn fs-1" aria-hidden="true"></i><br>
                 Announcements
               </a>
               <a href="fees.php" class="col btn btn-dark m-2 py-4">
               <i class="fa fa-money fs-1" aria-hidden="true"></i><br>
                 Student Fees management
               </a>
               <a href="routine.php" class="col btn btn-dark m-2 py-4">
               <i class="fa fa-calendar fs-1" aria-hidden="true"></i><br>
                 Schedule
               </a>

               <a href="../logout.php" class="col btn btn-danger m-2 py-4">
